//
//  ArrayDataSourceSegment.swift
//  Kraken
//
//  Created by Chall Fry on 1/21/20.
...
class ArrayDataSourceSegment<ModelObjectType>: KrakenDataSourceSegment, KrakenDataSourceSegmentProtocol {
	...
	var createCellModel: ((_ fromModel: ModelObjectType) -> BaseCellModel)?
	...
	func activate(array: [ModelObjectType], predicate: NSPredicate?, sort: [NSSortDescriptor]?, 
			cellModelFactory: ((_ from: ModelObjectType) -> BaseCellModel)?) {
